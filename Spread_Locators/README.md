# 📊 Spread Locator Dataset Statistical Analysis

## 📌 Project Overview

This project focuses on analyzing transaction data from the **Spread Locator Dataset** using statistical distributions, probability concepts, and data transformation techniques.

The objective is to understand transaction behavior, identify patterns in transaction amounts and counts, evaluate probability distributions, assess normality, and apply transformations to improve data quality for further statistical analysis.
...
The **Probability Density Function (PDF)** was used to visualize the distribution of transaction amounts.
...
The **Cumulative Distribution Function (CDF)** was used to evaluate cumulative probabilities.
...
* 🎲 **Bernoulli** and **Binomial** distributions were used to study transaction success.
* 📈 **Poisson Distribution** modeled transaction frequency.
* 💰 **Log-Normal** and ⚡ **Power-Law** distributions examined transaction amounts.
* 📉 **Q-Q Plot** and 🔄 **Box-Cox Transformation** were utilized to assess and improve normality.
* 📏 **Z-Score Analysis** identified unusual observations and potential outliers.
* 📚 **PDF** and 📖 **CDF** visualizations provided a deeper understanding of probability distributions and transaction patterns.

Overall, the project delivers valuable insights into transaction behavior and supports more informed data-driven decision-making.
